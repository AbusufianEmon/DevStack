...
Technologies Used:
  ...
  -Vite
Features:
  -Browse and explore technologies - View a list of tools across categories (frontend, backend, database, styling, DevOps) with details like difficulty level, rating,         and description.
  -Build your own stack - Add technologies to a personal "Your Stack" panel with a single click, with duplicate-prevention and instant visual feedback (disabled button +      checkmark once added).
  -Manage your selections - Remove individual technologies or clear the entire stack at once, with toast notifications confirming every action.
